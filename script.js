        ...
        .then(str => {
            ...
            items.forEach(item => {
                ...
                * IntelliJ IDEA: a Java integrated development environment for software developers:
                ...
                Requirement 2: Acronyms: Words used as the basis of acronyms should BOTH untranslated AND translated (i.e., CSS: Cascading Style Sheets o Hojas de Estilo en Cascada).
